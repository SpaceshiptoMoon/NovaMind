...
# 保留此处 re-export，使现有 `from novamind_engine_core.prompts.templates import PromptManager`
# 调用方继续可用；新代码应直接 `from novamind_engine_core.prompts import PromptManager`。
from novamind_engine_core.prompts.prompt_manager import (  # noqa: E402,F401
    PromptManager,
    format_prompt,
    get_prompt,
)
