...
from novamind.features.knowledge_space.integrations.deepdoc.compat import MAXIMUM_PAGE_NUMBER
from novamind.features.knowledge_space.integrations.deepdoc.core.models import DeepDocParseResult, strip_position_tags
...
from novamind.features.knowledge_space.integrations.deepdoc.pdf_layout import PdfLayoutExtractor
from novamind.features.knowledge_space.integrations.deepdoc.parsers.pdf_plain import RAGFlowPlainPdfParser
from novamind.features.knowledge_space.integrations.deepdoc.updown_concat import UpDownConcatMerger
from novamind.features.knowledge_space.integrations.deepdoc.vision_runtime import get_vision_health_status
...
class RAGFlowPdfParser:
    ...
    def _get_layout_recognizer(self):
        if self._layout_recognizer is None:
            ...
            from novamind.features.knowledge_space.integrations.deepdoc.vision.layout_recognizer import (
    ...
    def _extract_vendored_ocr_blocks(
        ...
        try:
            if self._ocr is None:
                from novamind.features.knowledge_space.integrations.deepdoc.vision.ocr import OCR
