...
from novamind.features.knowledge_space.integrations.deepdoc.compat import LazyImage
from novamind.features.knowledge_space.integrations.deepdoc.parsers.upstream.figure_parser import VisionFigureParser
