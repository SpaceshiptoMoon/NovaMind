...
from novamind.features.knowledge_space.integrations.deepdoc.figure_support import (
    LLMType,
    LLMBundle,
...
def vision_figure_parser_docx_wrapper(sections, tbls, callback=None, **kwargs):
    ...
    vision_model = parser_kwargs.pop("vision_model", None)
...
def vision_figure_parser_pdf_wrapper(tbls, callback=None, **kwargs):
    ...
    callback = callback or (lambda progress, message: None)
    parser_kwargs = dict(kwargs)
    sections = parser_kwargs.get("sections")
    parser_config = parser_kwargs.get("parser_config", {})
...
FigureParser = VisionFigureParser
