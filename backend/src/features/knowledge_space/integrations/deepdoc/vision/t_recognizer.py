...
from novamind.features.knowledge_space.integrations.deepdoc.vision._diagnostic_io import iter_diagnostic_images
...
from novamind.features.knowledge_space.integrations.deepdoc.vision.seeit import draw_box
