...
class Recognizer:
    ...
    def preprocess(self, image_list):
        ...
        if "scale_factor" in self.input_names:
            from novamind.features.knowledge_space.integrations.deepdoc.vision import operators
            from novamind.features.knowledge_space.integrations.deepdoc.vision.operators import preprocess
