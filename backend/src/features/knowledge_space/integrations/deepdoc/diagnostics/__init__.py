...
_EXPORT_MAP = {
    ...
    "get_missing_runtime_dependencies": ("novamind.features.knowledge_space.integrations.deepdoc.diagnostics.dependencies", "get_missing_runtime_dependencies"),
    "probe_module": ("novamind.features.knowledge_space.integrations.deepdoc.diagnostics.dependencies", "probe_module"),
