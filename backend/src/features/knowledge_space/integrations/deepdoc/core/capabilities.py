...
from novamind.features.knowledge_space.integrations.deepdoc.vision_runtime import get_vision_health_status, get_vision_runtime_status
...
def get_deepdoc_capabilities() -> Dict[str, Any]:
    ...
    try:
        from novamind.features.knowledge_space.integrations.deepdoc.parsers.remote.tcadp import TENCENTCLOUD_SDK_AVAILABLE
    except Exception:
    ...
    return {
        ...
        "specialized_modules": {
            "resume": {
                ...
                "entrypoint": "novamind.features.knowledge_space.integrations.deepdoc.parsers.upstream.resume.refactor",
            }
        },
        "parser_ids": [
            "pdf_layout",
