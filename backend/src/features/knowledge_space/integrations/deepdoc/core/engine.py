...
from novamind.features.knowledge_space.integrations.deepdoc.vision.model_manager import get_model_status
...
class DeepDocEngine:
    ...
    def ensure_vision_model_group(group: str):
        from novamind.features.knowledge_space.integrations.deepdoc.vision.model_manager import ensure_model_group_available

        return ensure_model_group_available(group)

    @staticmethod
    def download_vision_models(group: str | None = None):
        from novamind.features.knowledge_space.integrations.deepdoc.vision.model_manager import download_model_group

        return download_model_group(group)

    @staticmethod
    def download_text_concat_model():
        from novamind.features.knowledge_space.integrations.deepdoc.text_concat_model import download_text_concat_model as download_text_concat_model_artifact
