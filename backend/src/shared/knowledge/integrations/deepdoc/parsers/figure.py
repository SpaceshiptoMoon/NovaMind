...
from novamind.shared.knowledge.integrations.deepdoc.compat import LazyImage
from novamind.shared.knowledge.integrations.deepdoc.parsers.upstream.figure_parser import VisionFigureParser
