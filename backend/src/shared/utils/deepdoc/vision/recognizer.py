...
from src.shared.utils.deepdoc.vision.model_manager import ensure_model_group_available
...
class Recognizer:
    ...
    def preprocess(self, image_list):
        ...
        if "scale_factor" in self.input_names:
            from src.shared.utils.deepdoc.vision import operators
            from src.shared.utils.deepdoc.vision.operators import preprocess
