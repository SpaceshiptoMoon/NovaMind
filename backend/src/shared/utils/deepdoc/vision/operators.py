...
def create_operators(op_param_list, global_config=None):
    from src.shared.utils.deepdoc.vision.ocr import create_operators as _create_operators

    return _create_operators(op_param_list, global_config)


def transform(data, ops=None):
    from src.shared.utils.deepdoc.vision.ocr import transform as _transform
