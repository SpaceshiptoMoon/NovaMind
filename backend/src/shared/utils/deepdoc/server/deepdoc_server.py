...
from src.shared.utils.deepdoc.server.endpoints import (
    create_dla_router,
...
def create_deepdoc_app(engine: Optional[DeepDocEngine] = None) -> FastAPI:
    ...
    try:
        from src.shared.utils.deepdoc.server.adapters import DLAAdapter
    ...
    try:
        from src.shared.utils.deepdoc.server.adapters import OCRAdapter
    ...
    try:
        from src.shared.utils.deepdoc.server.adapters import TSRAdapter
