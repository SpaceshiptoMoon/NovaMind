...
from src.shared.integrations.deepdoc.vision.model_manager import ensure_model_group_available
...
class Recognizer:
    ...
    def preprocess(self, image_list):
        ...
        if "scale_factor" in self.input_names:
            from src.shared.integrations.deepdoc.vision import operators
            from src.shared.integrations.deepdoc.vision.operators import preprocess
