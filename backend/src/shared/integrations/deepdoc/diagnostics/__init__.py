...
_EXPORT_MAP = {
    ...
    "get_missing_runtime_dependencies": ("src.shared.integrations.deepdoc.diagnostics.dependencies", "get_missing_runtime_dependencies"),
    "probe_module": ("src.shared.integrations.deepdoc.diagnostics.dependencies", "probe_module"),
