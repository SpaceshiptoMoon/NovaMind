...
| **minio** | 9005 / 9001 | MinIO 对象存储（9001 为控制台，admin123/admin123） |
...
- MinIO 控制台：http://localhost:9001（账号：admin123 / admin123）
- Elasticsearch：http://localhost:9200

**首次启动**会自动创建数据库表和管理员账户（admin / admin123），无需手动操作。
...
# 查看 MySQL 数据
docker compose exec mysql mysql -uroot -p139790 novamind_db
