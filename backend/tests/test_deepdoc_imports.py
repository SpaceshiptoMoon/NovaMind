...
def test_deepdoc_package_lazy_exports_do_not_force_optional_format_imports():
    ...
    from novamind.features.knowledge_space.integrations.deepdoc import build_doctor_payload
    from novamind.features.knowledge_space.integrations.deepdoc import TxtParser
...
def test_deepdoc_top_level_exports_include_service_helpers():
    from novamind.features.knowledge_space.integrations.deepdoc import create_deepdoc_app
    from novamind.features.knowledge_space.integrations.deepdoc import download_deepdoc_dependencies
