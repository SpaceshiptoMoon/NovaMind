...
from novamind.core.authorization.dependencies import get_permission_checker, require_permission
...
def _make_app(user: dict):
    ...
    app.dependency_overrides[get_permission_checker] = lambda: FakeChecker(
