...
| **知识空间** | `stores/space.ts` | `SpaceListView`, `KnowledgeBaseView`, `DocumentView`, `DocumentDetailView`, `SearchView`, `SpaceSettingsView` | `api/space.ts`, `api/knowledgeBase.ts`, `api/document.ts`, `api/search.ts`, `api/member.ts` | `/api/v1/spaces` |
...
| `/home/spaces/:id` | 知识库管理 | MainLayout |
| `/home/spaces/:id/kbs/:kbId` | 文档管理 | MainLayout |
| `/home/spaces/:id/kbs/:kbId/documents/:docId` | 文档详情 | MainLayout |
| `/home/spaces/:id/kbs/:kbId/search` | 搜索 | MainLayout |
| `/home/spaces/:id/kbs/:kbId/evaluation` | 知识库评估 | MainLayout |
...
│   ├── types.ts                   # ~1200 行全局 TypeScript 类型定义
...
└── utils/markdown.ts              # marked + highlight.js 渲染管线
```
