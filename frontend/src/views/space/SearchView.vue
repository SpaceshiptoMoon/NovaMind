    ...
    <el-card class="search-card">
      <el-form :model="searchForm" label-width="100px">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="大模型生成">
              <el-switch v-model="searchForm.llm_enabled" />
            </el-form-item>
          </el-col>
        </el-row>

        <!-- 高级设置折叠面板 -->
        <el-collapse v-model="advancedSettingsActive" class="advanced-collapse">
          <el-collapse-item title="高级设置" name="advanced">
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="向量权重">
                  <el-slider
                    v-model="searchForm.vector_weight"
                    :min="0"
                    :max="1"
                    :step="0.1"
                    show-input
              ...
              <el-col :span="12">
                <el-form-item label="BM25权重">
                  <el-slider
                    v-model="searchForm.bm25_weight"
                    :min="0"
                    :max="1"
                    :step="0.1"
                    show-input
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="内容权重">
                  <el-slider
                    v-model="searchForm.content_weight"
                    :min="0"
                    :max="1"
                    :step="0.1"
                    show-input
              ...
              <el-col :span="12">
                <el-form-item label="问题权重">
                  <el-slider
                    v-model="searchForm.question_weight"
                    :min="0"
                    :max="1"
                    :step="0.1"
                    show-input
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="RRF 平滑参数">
                  <el-input-number
                    v-model="searchForm.rrf_k"
                    :min="1"
                    :max="200"
                    style="width: 100%"
                  />
            ...
            <el-form-item label="分数阈值">
              <el-slider
                ...
                :show-input-controls="false"
              />
              <span class="form-tip">低于此阈值的结果将被过滤</span>
            </el-form-item>

            <!-- Rerank 配置 -->
            <el-divider content-position="left">重排序配置</el-divider>
            <el-row :gutter="20">
              <el-col :span="8">
              ...
              <el-col :span="8">
                <el-form-item label="Rerank 数量">
                  <el-input-number
                    v-model="searchForm.rerank_top_k"
                    :min="1"
                    :max="20"
                    :disabled="!searchForm.rerank_enabled"
                    style="width: 100%"
                  />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="Rerank 模型">
                  <el-select
                    v-model="searchForm.rerank_model"
                    :disabled="!searchForm.rerank_enabled"
                    placeholder="使用系统默认"
                    clearable
                    style="width: 100%"
                  >
                    <el-option
                      v-for="m in availableRerankModels"
                      :key="m"
                      :label="m"
                      :value="m"
                    />
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="8">
                <el-form-item label="生成温度">
                  <el-slider
                    v-model="searchForm.llm_temperature"
                    :min="0"
                    :max="2"
                    :step="0.1"
                    :disabled="!searchForm.llm_enabled"
            ...
            <!-- 查询改写配置 -->
            <el-divider content-position="left">查询改写</el-divider>
            <el-row :gutter="20">
              <el-col :span="8">
              ...
              <el-col :span="8">
                <el-form-item label="改写模型">
                  <el-input
                    v-model="searchForm.qrw_llm_model"
                    :disabled="!searchForm.qrw_strategy"
                    placeholder="使用系统默认"
                  />
                </el-form-item>
              </el-col>
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item
                  v-if="searchForm.qrw_strategy === 'hyde'"
                  label="HyDE 提示词"
                >
                  <el-input
                    v-model="searchForm.qrw_hyde_prompt"
                    type="textarea"
                    :rows="2"
                    maxlength="2000"
                    placeholder="为空使用系统默认提示词"
                  />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row v-if="searchForm.qrw_strategy === 'sub_query'" :gutter="20">
              <el-col :span="8">
                <el-form-item label="子问题数量">
                  <el-input-number
                    v-model="searchForm.qrw_sub_query_count"
                    :min="2"
                    :max="5"
                    style="width: 100%"
                  />
            ...
            <el-form-item label="额外过滤">
              <el-input
                v-model="searchForm.filters_json"
                type="textarea"
                :rows="2"
                placeholder='JSON 格式，如 {"document_id": 1}'
              />
              <span class="form-tip">可选，JSON 格式的额外过滤条件</span>
            </el-form-item>
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="自动降级">
                  <el-switch v-model="searchForm.fallback_on_unavailable" />
                </el-form-item>
              </el-col>
            </el-row>
          </el-collapse-item>
        ...
        <el-form-item>
          ...
          <span class="search-tip">按 Ctrl + Enter 快速检索</span>
        </el-form-item>
      </el-form>
    </el-card>
      ...
      <div class="results-list">
        ...
        >
          <div class="result-header">
            <span class="result-index">分块{{ result.chunk_index + 1 }}</span>
          ...
          <div class="result-footer">
            <span v-if="(result.metadata as Record<string, unknown>)?.page">页码: {{ (result.metadata as Record<string, unknown>).page }}</span>
          </div>
...
const advancedSettingsActive = ref<string[]>([])
