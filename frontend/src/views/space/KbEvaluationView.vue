      ...
      <div class="kb-content">
            ...
            <el-table :data="testSets" v-loading="tsLoading" stripe>
              ...
              <el-table-column label="操作" width="200" fixed="right">
                <template #default="{ row }">
                  ...
                  <el-button link size="small" @click="handlePreviewTestSet(row)"> 预览 </el-button>
            ...
            <el-table :data="tasks" v-loading="taskLoading" stripe>
              ...
              <el-table-column prop="status" label="状态" width="140" align="center">
                <template #default="{ row }">
                  ...
                  <template
                    v-if="
                      taskProgress[row.id] && (row.status === 'running' || row.status === 'pending')
                    "
                  >
        ...
        >
          ...
          <div v-else-if="previewCases.length">
            ...
            <el-collapse>
              <el-collapse-item v-for="(tc, idx) in previewCases" :key="idx" :name="idx">
                <template #title>
        ...
        >
          <el-form ref="taskFormRef" :model="taskForm" :rules="taskRules" label-width="90px">
            ...
            <el-row :gutter="16">
              ...
              <el-col :span="12">
                <el-form-item label="Embedding">
                  <el-select
                    v-model="taskForm.embedding_model"
                    placeholder="用户默认"
                    clearable
                    style="width: 100%"
                  >
            ...
            <el-row :gutter="16">
              ...
              <el-col :span="8">
                <el-form-item label="分数阈值">
                  <el-input-number
                    v-model="taskForm.score_threshold"
                    :min="0"
                    :max="1"
                    :step="0.1"
                    :precision="1"
            ...
            <div class="switch-group">
              ...
              <el-checkbox v-model="taskForm.enable_context_precision"
                >Context Precision</el-checkbox
              >
              <el-checkbox v-model="taskForm.enable_context_recall">Context Recall</el-checkbox>
              <el-checkbox v-model="taskForm.enable_answer_similarity"
                >Answer Similarity</el-checkbox
              >
            </div>
          </el-form>
          <template #footer>
              ...
              <div class="report-summary">
                ...
                <div class="score-grid">
                    ...
                    <div class="score-items">
                      ...
                      >
                        ...
                        <span class="score-value"
                          >{{
                            (reportData.summary.retrieval.precision_at_k * 100).toFixed(1)
                          }}%</span
                        >
                      </div>
                      <div v-if="reportData.summary.retrieval.hit_rate != null" class="score-item">
                        ...
                        <span class="score-value"
                          >{{ (reportData.summary.retrieval.hit_rate * 100).toFixed(1) }}%</span
                        >
                      </div>
                      <div v-if="reportData.summary.retrieval.mrr != null" class="score-item">
                        <span class="score-label">MRR</span>
                        <span class="score-value">{{
                          reportData.summary.retrieval.mrr.toFixed(3)
                        }}</span>
                      </div>
                      <div
                        v-if="reportData.summary.retrieval.recall_at_k != null"
                        class="score-item"
                      >
                        <span class="score-label">Recall@K</span>
                        <span class="score-value"
                          >{{ (reportData.summary.retrieval.recall_at_k * 100).toFixed(1) }}%</span
                        >
                      </div>
                    </div>
                  </div>
                  ...
                  <div v-if="reportData.summary?.generation" class="score-section">
                    ...
                    <div class="score-items">
                      <div
                        v-if="reportData.summary.generation.correctness != null"
                        class="score-item"
                      >
                        <span class="score-label">正确性</span>
                        <span
                          class="score-value"
                          :class="getScoreClass(reportData.summary.generation.correctness)"
                        >
                          {{ reportData.summary.generation.correctness.toFixed(1) }}
                        </span>
                      </div>
                      <div
                        v-if="reportData.summary.generation.faithfulness != null"
                        class="score-item"
                      >
                        <span class="score-label">忠实度</span>
                        <span
                          class="score-value"
                          :class="getScoreClass(reportData.summary.generation.faithfulness)"
                        >
                          {{ reportData.summary.generation.faithfulness.toFixed(1) }}
                        </span>
                      </div>
                      <div
                        v-if="reportData.summary.generation.answer_relevance != null"
                        class="score-item"
                      >
                        <span class="score-label">相关性</span>
                        <span
                          class="score-value"
                          :class="getScoreClass(reportData.summary.generation.answer_relevance)"
                        >
                      ...
                      <div v-if="reportData.summary.generation.quality != null" class="score-item">
                        ...
                        <span
                          class="score-value"
                          :class="getScoreClass(reportData.summary.generation.quality)"
                        >
                          {{ reportData.summary.generation.quality.toFixed(1) }}
                        </span>
                      </div>
                      <div
                        v-if="reportData.summary.generation.overall != null"
                        class="score-item score-item-highlight"
                      >
                        <span class="score-label">综合</span>
                        <span
                          class="score-value"
                          :class="getScoreClass(reportData.summary.generation.overall)"
                        >
                  ...
                  <div v-if="reportData.summary?.end_to_end" class="score-section">
                    ...
                    <div class="score-items">
                      <div
                        v-if="reportData.summary.end_to_end.context_precision != null"
                        class="score-item"
                      >
                        <span class="score-label">Context Precision</span>
                        <span class="score-value"
                          >{{
                            (reportData.summary.end_to_end.context_precision * 100).toFixed(1)
                          }}%</span
                        >
                      </div>
                      <div
                        v-if="reportData.summary.end_to_end.context_recall != null"
                        class="score-item"
                      >
                        <span class="score-label">Context Recall</span>
                        <span class="score-value"
                          >{{
                            (reportData.summary.end_to_end.context_recall * 100).toFixed(1)
                          }}%</span
                        >
                      </div>
                      <div
                        v-if="reportData.summary.end_to_end.answer_similarity != null"
                        class="score-item"
                      >
                        <span class="score-label">Answer Similarity</span>
                        <span class="score-value"
                          >{{
                            (reportData.summary.end_to_end.answer_similarity * 100).toFixed(1)
                          }}%</span
                        >
                      </div>
                    </div>
                ...
                <el-collapse>
                  ...
                  >
                    <template #title>
                      <div class="detail-title">
                        ...
                        <div class="detail-scores-inline">
                          <el-tag
                            v-if="detail.generation_scores?.correctness != null"
                            size="small"
                            :type="getScoreTagType(detail.generation_scores.correctness)"
                          >
                    ...
                    <div class="detail-body">
                      ...
                      <el-row :gutter="16">
                        ...
                        <el-col :span="12">
                          <div class="answer-block">
                            ...
                            <div class="answer-text generated">
                              {{ detail.generated_answer || '未生成' }}
                            </div>
                          </div>
                        </el-col>
                      </el-row>
                      ...
                      <!-- 分数详情 -->
                      <div
                        v-if="detail.generation_scores || detail.retrieval || detail.end_to_end"
                        class="detail-scores"
                      >
                        <el-descriptions :column="4" size="small" border>
                          <el-descriptions-item
                            v-if="detail.retrieval?.precision_at_k != null"
                            label="Precision@K"
                          >
                            {{ (detail.retrieval.precision_at_k * 100).toFixed(1) }}%
                          </el-descriptions-item>
                          <el-descriptions-item
                            v-if="detail.generation_scores?.faithfulness != null"
                            label="忠实度"
                          >
                            {{ detail.generation_scores.faithfulness }}
                          </el-descriptions-item>
                          <el-descriptions-item
                            v-if="detail.generation_scores?.answer_relevance != null"
                            label="相关性"
                          >
                          ...
                          <el-descriptions-item
                            v-if="detail.generation_scores?.quality != null"
                            label="质量"
                          >
                            {{ detail.generation_scores.quality }}
                          </el-descriptions-item>
                          <el-descriptions-item
                            v-if="detail.end_to_end?.context_precision != null"
                            label="Ctx Precision"
                          >
                            {{ (detail.end_to_end.context_precision * 100).toFixed(1) }}%
                          </el-descriptions-item>
                          <el-descriptions-item
                            v-if="detail.end_to_end?.context_recall != null"
                            label="Ctx Recall"
                          >
                            {{ (detail.end_to_end.context_recall * 100).toFixed(1) }}%
                          </el-descriptions-item>
                          <el-descriptions-item
                            v-if="detail.end_to_end?.answer_similarity != null"
                            label="Ans Similarity"
                          >
...
async function handleUpload() {
  ...
  await uploadFormRef.value.validate(async (valid) => {
    ...
    try {
      await evaluationApi.uploadTestSet(
        spaceId.value,
        kbId.value,
        selectedFile.value!,
        uploadForm.name,
...
async function handleSubmitScores() {
  ...
  try {
    await evaluationApi.submitHumanScores(spaceId.value, kbId.value, reportData.value.task_id, {
      scores: validScores,
    })
