...
- 当历史方案已经落地并成为当前事实时，应把结论沉淀到这里。
- 这里的文档应保持和当前代码一致，不应继续堆叠纯过程性记录。
- 若某项内容仍处于试验、讨论或迁移阶段，应放到上级目录的 [`../process/README.md`](../process/README.md) 所指向的过程文档中。
